...
\begin{table}
  \caption{Prebiotic boundary conditions.}
  \label{tab:diseq_table4}
  \begin{center}
...
\begin{table}
  \caption{Boundary conditions for the chemotrophic ecosystem model.}
  \label{tab:diseq_table5}
  \begin{center}
...
\begin{table}
  \caption{Literature values for the activation energy of nitrogen fixation by chemical reduction.}
  \label{tab:diseq_table7}
  \begin{center}
  \begin{tabularx}{1.0\linewidth}{| >{\hsize=.15\hsize\centering\arraybackslash}X | >{\hsize=.15\hsize\raggedright\arraybackslash}X | >{\hsize=.2\hsize\raggedright\arraybackslash}X | >{\hsize=.5\hsize\raggedright\arraybackslash}X |}
  \hline
